...
- [ ] **Phase 13: Critical Bug Fixes + API Contract Lock** - 修复三个阻断性 bug，锁定 contracts.ts 防止重写期间 API drift
...
| 13. Bug Fixes + Contract Lock | v2.0 | 0/2 | Not started | - |
| 14. Frontend Rewrite | v2.0 | 0/4 | Not started | - |
